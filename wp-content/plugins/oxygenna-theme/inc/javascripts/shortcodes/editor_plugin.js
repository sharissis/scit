        ...
        tinymce.create('tinymce.plugins.ShortcodesPlugin', {
                ...
                init : function(ed, url) {
                        ...
                        ed.onInit.add(function(ed) {
                             if ( document.getElementById(tinyMCE.activeEditor.controlManager.get('shortcodes').id) )
                                tinymce.DOM.hide(tinyMCE.activeEditor.controlManager.get('shortcodes').id);
                        });
                    ...
                    switch( n ) {
                        case 'shortcodes':
                            ...
                            $.getJSON( ajaxurl + '?action=oxy_shortcodes_menu', function( data ) {
                                if ( document.getElementById(tinyMCE.activeEditor.controlManager.get('shortcodes').id) )
                                    tinymce.DOM.show(tinyMCE.activeEditor.controlManager.get('shortcodes').id);
