<?php
if ( ! class_exists( 'seed_csp3_MCAPI' ) ) {
class seed_csp3_MCAPI {
    var $version = "1.3";
    var $errorMessage;
    var $errorCode;
     ...
     */
    function seed_csp3_MCAPI($apikey, $secure=false) {
        $this->secure = $secure;
    ...
    */
     ...
     * @return boolean true on success, false on failure. When using seed_csp3_MCAPI.class.php, the value can be tested and error messages pulled from the seed_csp3_MCAPI object (see below)
     */
     ...
     * @return boolean true on success, false on failure. When using seed_csp3_MCAPI.class.php, the value can be tested and error messages pulled from the seed_csp3_MCAPI object
     */
    ...
    function callServer($method, $params) {
        ...
        $payload .= "Host: " . $host . "\r\n";
        $payload .= "User-Agent: seed_csp3_MCAPI/" . $this->version ."\r\n";
