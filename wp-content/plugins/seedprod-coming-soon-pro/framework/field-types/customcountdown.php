...
echo ',';
echo "<input id='aa' class='small-text' name='{$setting_id}[$id][year]' placeholder='".__('year','seedprod')."'  type='text' value='" . esc_attr( $options[ $id ]['year'] ) . "' />";

 echo " @  ";
 echo "<input type='text' id='hh' name='{$setting_id}[$id][hour]' value='" . esc_attr( $options[ $id ]['hour'] ) . "' size='2' maxlength='2' tabindex='4' autocomplete='off' placeholder='".__('hh','seedprod')."'>";
 echo ": <input type='text' id='mn' name='{$setting_id}[$id][minute]' value='" . esc_attr( $options[ $id ]['minute'] ) . "' size='2' maxlength='2' tabindex='4' autocomplete='off' placeholder='".__('mm','seedprod')."'><br>";