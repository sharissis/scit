...
function display_day( $day, $monthView ) {
	...
	for ( $i = 0; $i < count( $monthView[$day] ); $i++ ) {
		...
		<div id='event_<?php echo $eventId; ?>' <?php post_class('tribe-events-event tribe-events-real-event') ?>>
			<a href="<?php tribe_event_link(); ?>"><?php echo $startTime; ?>: <?php scit_strip_datestamp_from_title();  ?></a>
			<?php // tribe_get_start_date(null, true, 'hA') ?>
			<div id='t00ltip_<?php echo $eventId; ?>' class="tribe-events-t00ltip" style="display:none;">
