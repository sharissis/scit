...
<li <?php echo $class ?>>
	...
	<div class="event">
		<a href="<?php echo tribe_get_event_link($post) ?>"><?php scit_strip_datestamp_from_title();  ?></a>
		<!--	Add a Quick Link to The Ticket
		<br/>
		<a href="<?php echo $URI;?>?add-to-cart=<?php echo $ticket->ID; ?>" rel="nofollow" data-product_id="<?php echo $ticket->ID; ?>" class="add_to_cart_button button product_type_simple">Quick Add</a>
		-->
