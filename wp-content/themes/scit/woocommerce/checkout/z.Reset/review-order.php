...
<!-- 	
	<div class="twelvecol">
		...
		<h4>Billing / Purchaser / Guardian</h4>
		<div class="threecol first clearfix pull-left">
			First<br/>
			<input type="text" class="input-text" />
		</div>
		<div class="threecol clearfix pull-left">
			Last<br/>
			<input type="text" class="input-text" />
		</div>
		<div class="threecol clearfix pull-left">
		...
		<div class="threecol clearfix last pull-left">
			Phone<br/>
			<input type="text" class="input-text" />
		</div>
		<div class="clearfix">&nbsp;</div>
		
		<h4>Shipping / Student / Attendee<br/><span class="small"><input type="checkbox" name="check1" onchange="copyTextValue(this);"/> Check if same as Billing</span></h4>
		<div class="threecol first clearfix pull-left">
			First<br/>
			<input type="text" class="input-text" />
		</div>
