	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			<p class="form-row terms">
				<label for="terms" class="checkbox"><?php _e( 'I have read and accept the', 'woocommerce' ); ?> <a href="<?php echo esc_url( get_permalink(woocommerce_get_page_id('terms')) ); ?>" target="_blank"><?php _e( 'Course Enrollment Policy', 'woocommerce' ); ?></a></label>
			...
			<?php
			/*
			////////	This is custom code to put the Course Enrollment Policy in a Modal, but for now don't do this.
			...
			//	<a class="close-reveal-modal">&#215;</a>
				...
				$page_id = 195; // Course Enrollment Policy

				$page_data = get_page( $page_id ); // 

				echo '<h1>'. $page_data->post_title .'</h1>';// echo the title
				echo '<p>'.apply_filters('the_content', $page_data->post_content).'</p>'; // echo the content and retain Wordpress filters such as paragraph tags.
