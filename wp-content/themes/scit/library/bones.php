...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			...
			'teams-nav' => __( 'Team Page', 'bonestheme' ),   // nav on the team page
			'people-nav' => __( 'People Page', 'bonestheme' ),   // nav on the people page
		)
	);
...
// the footer menu (should you choose to use one)
function scit_people_nav() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => '',                              // remove nav container
    	'container_class' => 'clearfix',   // class of container (should you choose to use it)
    	'menu' => __( 'People Page', 'bonestheme' ),   // nav name
    	'menu_class' => 'nav clearfix',      // adding custom nav class
    	'theme_location' => 'people-nav',             // where it's located in the theme
    	'before' => '',                                 // before the menu
        'after' => '',                                  // after the menu
        'link_before' => '',                            // before each link
        'link_after' => '',                             // after each link
...
// the footer menu (should you choose to use one)
function scit_teams_nav() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => '',                              // remove nav container
    	'container_class' => 'clearfix',   // class of container (should you choose to use it)
    	'menu' => __( 'Team Page', 'bonestheme' ),   // nav name
    	'menu_class' => 'nav clearfix',      // adding custom nav class
    	'theme_location' => 'teams-nav',             // where it's located in the theme
    	'before' => '',                                 // before the menu
        'after' => '',                                  // after the menu
        'link_before' => '',                            // before each link
        'link_after' => '',                             // after each link
