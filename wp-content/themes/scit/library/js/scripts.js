...
(function(w){
    ...
    // add all your scripts here
     function copyTextValue(bf) {
        ...
        document.getElementById("attendee_first_name_1").value = billingFirstName;
        document.getElementById("attendee_last_name_1").value = billingLastName;
        document.getElementById("attendee_email_1").value = billingEmail;
        document.getElementById("attendee_phone_1").value = billingPhone;
